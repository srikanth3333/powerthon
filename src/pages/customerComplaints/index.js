...
import {getComplaints,getDownload} from "../../redux/cutomerComplaints/customerComplaintsSlice";
...
const Index = () => {
    ...
    let focData = useSelector((state) => state.billComplaints)
    ...
    let [excelReady,setExcelReady] = useState(false)
    ...
    useEffect(() => {
        dispatch(getComplaints({page:0,startDate:'',endDate:'',category:'',circle_name:'',division_name:'',subdivision_name:'',minutes:''}))
        dispatch(getDownload({page:0,startDate:'',endDate:'',category:'',circle_name:'',division_name:'',subdivision_name:'',minutes:''}))
    },[])
            ...
            <Box component="main">
                <div className="container-fluid px-4 my-4">
                    ...
                    <div className="row align-items-end">
                        <div className="col-lg-2 mb-2">
                            ...
                            <select onChange={(e) => {
                                ...
                                dispatch(getComplaints({page:0,startDate:startDate,endDate:endDate,category:e.target.value,
                                    circle_name:circleName,division_name:divisionName,subdivision_name:subdivision,minutes:minutes}))
                                dispatch(getDownload({page:0,startDate:startDate,endDate:endDate,category:e.target.value,
                                    circle_name:circleName,division_name:divisionName,subdivision_name:subdivision,minutes:minutes}))
                        ...
                        <div className="col-lg-2 mb-2">
                            ...
                            <select onChange={(e) => {
                                ...
                                dispatch(getComplaints({page:0,startDate:startDate,endDate:endDate,category:category,
                                        ...
                                        dispatch(getDownload({page:0,startDate:startDate,endDate:endDate,category:category,
                                            circle_name:e.target.value,division_name:divisionName,subdivision_name:subdivision,minutes:minutes}))
                            }} className="form-select" aria-label="Default select example">
                        ...
                        <div className="col-lg-2 mb-2">
                            ...
                            <DatePicker 
                                ...
                                onSelect={(date) => {
                                    setStartDate(date)
                                    dispatch(getComplaints({page:0,startDate:date,endDate:endDate,category:category,
                                        circle_name:circleName,division_name:divisionName,subdivision_name:subdivision,minutes:minutes}))
                                        dispatch(getDownload({page:0,startDate:date,endDate:endDate,category:category,
                                            circle_name:circleName,division_name:divisionName,subdivision_name:subdivision,minutes:minutes}))
                        ...
                        <div className="col-lg-2 mb-2">
                            ...
                            <DatePicker 
                                ...
                                onSelect={(date) => {
                                    setEndDate(date)
                                    dispatch(getComplaints({page:0,startDate:startDate,endDate:date,category:category,
                                            circle_name:circleName,division_name:divisionName,subdivision_name:subdivision,minutes:minutes}))
                                            dispatch(getDownload({page:0,startDate:startDate,endDate:date,category:category,
                                                circle_name:circleName,division_name:divisionName,subdivision_name:subdivision,minutes:minutes}))
                                }} className="form-control" />
                        </div>
                        <div className="col-lg-2 mb-2">
                    ...
                    <div className="row mt-4">
                        ...
                        <div className="col-lg-6">
                            <PieChartGraph loadingState={focData.loading} data={focData.barGraphData} />
                        </div> */}
                    </div>
                </div>
            </Box>
